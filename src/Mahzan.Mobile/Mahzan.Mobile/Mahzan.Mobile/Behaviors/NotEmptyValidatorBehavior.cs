...
namespace Mahzan.Mobile.Behaviors
{
    ...
    {
        const string charactersRegex = @"^(?!\s*$).+";

        static readonly BindablePropertyKey IsValidPropertyKey = BindableProperty.CreateReadOnly("IsValid", typeof(bool?), typeof(NotEmptyValidatorBehavior), null);
